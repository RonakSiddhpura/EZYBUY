...
function AllProducts({priceOrder,setPriceOrder}) {
    const context = useContext(myContext)
    const { mode, product,setProduct,searchkey, setSearchkey,filterType,setFilterType,
   ...
   let [selectSort,setSelectSort]=useState([])
    ...
    // console.log("produict data :::: ",product)
    useEffect(() => {
                            ...
                            <div    key={index} className="p-4 md:w-1/4  drop-shadow-lg " >
                                <div  className="h-full border-2 hover:shadow-gray-100 hover:shadow-2xl transition-shadow duration-300 ease-in-out    border-gray-200 border-opacity-60 rounded-2xl overflow-hidden" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                    ...
                                    <div className="p-5 border-t-2">
                                        <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1" style={{ color: mode === 'dark' ? 'white' : '', }}>EZBUY</h2>
